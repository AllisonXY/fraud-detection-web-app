...
export default function FraudCheck() {
  ...
  return (
    <form id="FraudForm" className='form' onSubmit={handleSubmit}>
      <fieldset className="PolicyHolder border rounded bg-light">
        <legend className="dimension-button">Policy Holder Details</legend>
      ...
      <fieldset className="Policy border rounded bg-light">
        <legend className="dimension-button">Policy Details</legend>
      ...
      <fieldset className="Accident border rounded bg-light">
        <legend className="dimension-button">Accident Details</legend>
      ...
      <fieldset className="Vehicle border rounded bg-light">
        <legend className="dimension-button  ">Vehicle Details</legend>
        <div className="row">
          <div className="form-group col-md-6">
      ...
      <button type="submit" className="button btn btn-secondary" id="submitBtn" name="submit">Submit</button>
    </form>
  );
}
